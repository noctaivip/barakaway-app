(function () {
  ...
  var items = [
    ...
    {key:'prayer', label:L[1], href:'/prayer-times-' + lang + '.html', icon:'<svg viewBox="0 0 24 24"><path d="M12 3.5c2.8 2.1 4.8 5.4 4.8 9.2 0 3.4-1.8 6.2-4.8 7.8-3-1.6-4.8-4.4-4.8-7.8 0-3.8 2-7.1 4.8-9.2Z"/><path d="M12 8.5v5"/><path d="M9.5 13.5h5"/></svg>'},
