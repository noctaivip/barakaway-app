...
/* ===== BARAKAWAY PREMIUM THEME READABILITY FIX FINAL INJECTOR ===== */
(function(){
  const STYLE_ID = "barakaway-premium-theme-readability-fix-final";
  const CSS = `/* ===== BARAKAWAY PREMIUM THEME READABILITY FIX FINAL ===== */
/* Light premium themes: dark readable text. Emerald is kept as a dark green theme with stronger light text. */
html.premium-theme-royal-gold{--bw-readable-text:#2b1a06;--bw-readable-soft:#4b300f;--bw-readable-muted:#6f4a18;--bw-readable-accent:#5e3b0e;--bw-readable-shadow:0 1px 0 rgba(255,247,218,.55);}
html.premium-theme-children-soft{--bw-readable-text:#153246;--bw-readable-soft:#284d63;--bw-readable-muted:#4f7589;--bw-readable-accent:#375d73;--bw-readable-shadow:0 1px 0 rgba(255,255,255,.72);}
html.premium-theme-desert-sand{--bw-readable-text:#2f1d08;--bw-readable-soft:#543713;--bw-readable-muted:#7b5524;--bw-readable-accent:#6b4717;--bw-readable-shadow:0 1px 0 rgba(255,244,209,.60);}
html.premium-theme-emerald-quran{--bw-emerald-readable-text:#f8fff9;--bw-emerald-readable-soft:#e1f7e8;--bw-emerald-readable-muted:#c6edd3;--bw-emerald-readable-accent:#fff0b4;--bw-emerald-readable-shadow:0 2px 10px rgba(0,24,12,.58);}

html.premium-theme-royal-gold body,html.premium-theme-royal-gold .container,html.premium-theme-royal-gold .hero,html.premium-theme-royal-gold .brand-prayer-hero,html.premium-theme-royal-gold .today-hub,html.premium-theme-royal-gold .home-widget,html.premium-theme-royal-gold .card,html.premium-theme-royal-gold .box,html.premium-theme-royal-gold .panel,html.premium-theme-royal-gold .block,html.premium-theme-royal-gold .about-project-card,html.premium-theme-royal-gold .barakaway-pro-final,html.premium-theme-royal-gold .premium-resource-card,html.premium-theme-royal-gold .bottom-app-nav,html.premium-theme-royal-gold .bottom-app-nav-inner,
html.premium-theme-children-soft body,html.premium-theme-children-soft .container,html.premium-theme-children-soft .hero,html.premium-theme-children-soft .brand-prayer-hero,html.premium-theme-children-soft .today-hub,html.premium-theme-children-soft .home-widget,html.premium-theme-children-soft .card,html.premium-theme-children-soft .box,html.premium-theme-children-soft .panel,html.premium-theme-children-soft .block,html.premium-theme-children-soft .about-project-card,html.premium-theme-children-soft .barakaway-pro-final,html.premium-theme-children-soft .premium-resource-card,html.premium-theme-children-soft .bottom-app-nav,html.premium-theme-children-soft .bottom-app-nav-inner,
html.premium-theme-desert-sand body,html.premium-theme-desert-sand .container,html.premium-theme-desert-sand .hero,html.premium-theme-desert-sand .brand-prayer-hero,html.premium-theme-desert-sand .today-hub,html.premium-theme-desert-sand .home-widget,html.premium-theme-desert-sand .card,html.premium-theme-desert-sand .box,html.premium-theme-desert-sand .panel,html.premium-theme-desert-sand .block,html.premium-theme-desert-sand .about-project-card,html.premium-theme-desert-sand .barakaway-pro-final,html.premium-theme-desert-sand .premium-resource-card,html.premium-theme-desert-sand .bottom-app-nav,html.premium-theme-desert-sand .bottom-app-nav-inner{color:var(--bw-readable-text) !important;}

html.premium-theme-royal-gold :where(h1,h2,h3,h4,h5,h6,.title,.section-title,.category-title,.dua-title,.surah-name,.ayah-arabic,.prayer-name,.big-location,.next-name),
html.premium-theme-children-soft :where(h1,h2,h3,h4,h5,h6,.title,.section-title,.category-title,.dua-title,.surah-name,.ayah-arabic,.prayer-name,.big-location,.next-name),
html.premium-theme-desert-sand :where(h1,h2,h3,h4,h5,h6,.title,.section-title,.category-title,.dua-title,.surah-name,.ayah-arabic,.prayer-name,.big-location,.next-name){color:var(--bw-readable-text) !important;-webkit-text-fill-color:var(--bw-readable-text) !important;text-shadow:var(--bw-readable-shadow) !important;}

html.premium-theme-royal-gold :where(p,li,small,span,label,.subtitle,.small,.note,.muted,.label,.meaning,.when,.surah-meta,.article p,.dua-translit,.ayah-translit,.ayah-meaning,.countdown-note,.wallet-note,.prayer-meta,.month-fajr,.month-maghrib,.translit,.ref),
html.premium-theme-children-soft :where(p,li,small,span,label,.subtitle,.small,.note,.muted,.label,.meaning,.when,.surah-meta,.article p,.dua-translit,.ayah-translit,.ayah-meaning,.countdown-note,.wallet-note,.prayer-meta,.month-fajr,.month-maghrib,.translit,.ref),
html.premium-theme-desert-sand :where(p,li,small,span,label,.subtitle,.small,.note,.muted,.label,.meaning,.when,.surah-meta,.article p,.dua-translit,.ayah-translit,.ayah-meaning,.countdown-note,.wallet-note,.prayer-meta,.month-fajr,.month-maghrib,.translit,.ref){color:var(--bw-readable-soft) !important;-webkit-text-fill-color:var(--bw-readable-soft) !important;text-shadow:var(--bw-readable-shadow) !important;}

html.premium-theme-royal-gold :where(strong,a,.badge,.chip,.wallet-badge,.surah-number,.meta-value,.prayer-time,.month-num,.quick-btn.active,.today-action),
html.premium-theme-children-soft :where(strong,a,.badge,.chip,.wallet-badge,.surah-number,.meta-value,.prayer-time,.month-num,.quick-btn.active,.today-action),
html.premium-theme-desert-sand :where(strong,a,.badge,.chip,.wallet-badge,.surah-number,.meta-value,.prayer-time,.month-num,.quick-btn.active,.today-action){color:var(--bw-readable-accent) !important;-webkit-text-fill-color:var(--bw-readable-accent) !important;text-shadow:var(--bw-readable-shadow) !important;}

html.premium-theme-royal-gold :where(button:not(.icon-btn):not(.share-close):not(.install-help-close):not(.bottom-app-nav-item),.btn,.quick-btn,.today-action,.copy-wallet-btn,.install-btn),
html.premium-theme-children-soft :where(button:not(.icon-btn):not(.share-close):not(.install-help-close):not(.bottom-app-nav-item),.btn,.quick-btn,.today-action,.copy-wallet-btn,.install-btn),
html.premium-theme-desert-sand :where(button:not(.icon-btn):not(.share-close):not(.install-help-close):not(.bottom-app-nav-item),.btn,.quick-btn,.today-action,.copy-wallet-btn,.install-btn){color:var(--bw-readable-text) !important;-webkit-text-fill-color:var(--bw-readable-text) !important;text-shadow:var(--bw-readable-shadow) !important;}

html.premium-theme-royal-gold :where(.bottom-app-nav-item,.bottom-app-nav-item span),
html.premium-theme-children-soft :where(.bottom-app-nav-item,.bottom-app-nav-item span),
html.premium-theme-desert-sand :where(.bottom-app-nav-item,.bottom-app-nav-item span){color:var(--bw-readable-soft) !important;-webkit-text-fill-color:var(--bw-readable-soft) !important;text-shadow:var(--bw-readable-shadow) !important;}

html.premium-theme-royal-gold :where(.bottom-app-nav-item.active,.bottom-app-nav-item.is-active,.bottom-app-nav-item.active span,.bottom-app-nav-item.is-active span),
html.premium-theme-children-soft :where(.bottom-app-nav-item.active,.bottom-app-nav-item.is-active,.bottom-app-nav-item.active span,.bottom-app-nav-item.is-active span),
html.premium-theme-desert-sand :where(.bottom-app-nav-item.active,.bottom-app-nav-item.is-active,.bottom-app-nav-item.active span,.bottom-app-nav-item.is-active span){color:var(--bw-readable-text) !important;-webkit-text-fill-color:var(--bw-readable-text) !important;}

html.premium-theme-emerald-quran :where(h1,h2,h3,h4,h5,h6,.title,.section-title,.category-title,.dua-title,.surah-name,.ayah-arabic,.prayer-name,.big-location,.next-name){color:var(--bw-emerald-readable-text) !important;-webkit-text-fill-color:var(--bw-emerald-readable-text) !important;text-shadow:var(--bw-emerald-readable-shadow) !important;}
html.premium-theme-emerald-quran :where(p,li,small,span,label,.subtitle,.small,.note,.muted,.label,.meaning,.when,.surah-meta,.article p,.dua-translit,.ayah-translit,.ayah-meaning,.countdown-note,.wallet-note,.prayer-meta,.month-fajr,.month-maghrib,.translit,.ref){color:var(--bw-emerald-readable-soft) !important;-webkit-text-fill-color:var(--bw-emerald-readable-soft) !important;text-shadow:var(--bw-emerald-readable-shadow) !important;}
html.premium-theme-emerald-quran :where(strong,a,.badge,.chip,.wallet-badge,.surah-number,.meta-value,.prayer-time,.month-num,.quick-btn.active,.today-action){color:var(--bw-emerald-readable-accent) !important;-webkit-text-fill-color:var(--bw-emerald-readable-accent) !important;text-shadow:var(--bw-emerald-readable-shadow) !important;}

body .theme-grid .theme-card[data-theme="royal-gold"] :where(h3,p),body .theme-grid .theme-card.theme-gold :where(h3,p),body .theme-grid .theme-card[data-theme="desert-sand"] :where(h3,p),body .theme-grid .theme-card.theme-sand :where(h3,p){color:#2b1a06 !important;-webkit-text-fill-color:#2b1a06 !important;text-shadow:0 1px 0 rgba(255,255,255,.62) !important;}
body .theme-grid .theme-card[data-theme="children-soft"] :where(h3,p),body .theme-grid .theme-card.theme-child :where(h3,p){color:#153246 !important;-webkit-text-fill-color:#153246 !important;text-shadow:0 1px 0 rgba(255,255,255,.72) !important;}
body .theme-grid .theme-card[data-theme="royal-gold"] .theme-chip,body .theme-grid .theme-card.theme-gold .theme-chip,body .theme-grid .theme-card[data-theme="children-soft"] .theme-chip,body .theme-grid .theme-card.theme-child .theme-chip,body .theme-grid .theme-card[data-theme="desert-sand"] .theme-chip,body .theme-grid .theme-card.theme-sand .theme-chip{color:#2b1a06 !important;-webkit-text-fill-color:#2b1a06 !important;background:rgba(255,255,255,.36) !important;border-color:rgba(60,36,8,.18) !important;}
/* ===== END BARAKAWAY PREMIUM THEME READABILITY FIX FINAL ===== */`;
...
/* ===== END BARAKAWAY PREMIUM THEME READABILITY FIX FINAL INJECTOR ===== */
