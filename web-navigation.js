(function(){
  ...
  var FOOTER={"ru": [[["terms-ru.html", "Условия использования"], ["privacy-policy-ru.html", "Политика конфиденциальности"], ["about-ru.html", "О проекте"], ["private-chat-ru.html", "Чат"]], "Установить приложение", "Все права защищены.", "Ссылки футера"], "en": [[["terms-en.html", "Terms of Use"], ["privacy-policy-en.html", "Privacy Policy"], ["about-en.html", "About"], ["private-chat-en.html", "Chat"]], "Install App", "All rights reserved.", "Footer links"], "ar": [[["terms-ar.html", "شروط الاستخدام"], ["privacy-policy-ar.html", "سياسة الخصوصية"], ["about-ar.html", "عن المشروع"], ["private-chat-ar.html", "الدردشة"]], "تثبيت التطبيق", "جميع الحقوق محفوظة.", "روابط التذييل"], "tr": [[["terms-tr.html", "Kullanım şartları"], ["privacy-policy-tr.html", "Gizlilik politikası"], ["about-tr.html", "Hakkında"], ["private-chat-tr.html", "Sohbet"]], "Uygulamayı yükle", "Tüm hakları saklıdır.", "Footer links"], "uz": [[["terms-uz.html", "Foydalanish shartlari"], ["privacy-policy-uz.html", "Maxfiylik siyosati"], ["about-uz.html", "Loyiha haqida"], ["private-chat-uz.html", "Chat"]], "Ilovani o‘rnatish", "Barcha huquqlar himoyalangan.", "Footer links"], "kz": [[["terms-kz.html", "Пайдалану шарттары"], ["privacy-policy-kz.html", "Құпиялылық саясаты"], ["about-kz.html", "Жоба туралы"], ["private-chat-kz.html", "Чат"]], "Қолданбаны орнату", "Барлық құқықтар қорғалған.", "Footer links"], "id": [[["terms-id.html", "Ketentuan Penggunaan"], ["privacy-policy-id.html", "Kebijakan Privasi"], ["about-id.html", "Tentang"], ["private-chat-id.html", "Chat"]], "Instal Aplikasi", "Hak cipta dilindungi.", "Footer links"], "hi": [[["terms-hi.html", "उपयोग की शर्तें"], ["privacy-policy-hi.html", "गोपनीयता नीति"], ["about-hi.html", "परियोजना के बारे में"], ["private-chat-hi.html", "चैट"]], "ऐप इंस्टॉल करें", "सभी अधिकार सुरक्षित.", "Footer links"], "bn": [[["terms-bn.html", "ব্যবহারের শর্তাবলী"], ["privacy-policy-bn.html", "গোপনীয়তা নীতি"], ["about-bn.html", "প্রকল্প সম্পর্কে"], ["private-chat-bn.html", "চ্যাট"]], "অ্যাপ ইনস্টল করুন", "সর্বস্বত্ব সংরক্ষিত.", "Footer links"], "ur": [[["terms-ur.html", "استعمال کی شرائط"], ["privacy-policy-ur.html", "پرائیویسی پالیسی"], ["about-ur.html", "منصوبے کے بارے میں"], ["private-chat-ur.html", "چیٹ"]], "ایپ انسٹال کریں", "تمام حقوق محفوظ ہیں.", "Footer links"]};
